...
<body>
    ...
    border-bottom-right-radius:10px ;"><a href="logout.php">Pờ rô pờ lem</a></li>
            ...
            <div id="produc-item-right-iphone">
                <h1>THỐNG KẾ HÀNG HOÁ TỪNG LOẠI</h1>
                <table>
                    <thead>
                        <tr>
                            <th>LOẠI HÀNG</th>
                            <th>SỐ LƯỢNG</th>
                            <th>GIÁ CAO NHẤT (VNĐ)</th>
                            <th>GIÁ THẤP NHẤT (VNĐ)</th>
                    ...
                    <tbody>
                        <?php foreach ($listSP as $row) { ?>
                            <tr>
                                ...
                                <td><?= $row['number_cate'] ?></td>
                                <td><?= number_format($row['gia_min'], 0, ",", ".") ?></td>
                                <td><?= number_format($row['gia_cao_nhat'], 0, ",", ".") ?></td>
                                <td><?= number_format($row['gia_trung_binh'], 0, ",", ".") ?></td>
                            </tr>
                        <?php }  ?>
                    </tbody>
                </table>
