    ...
    border-bottom-right-radius:10px ;"><a href="logout.php">Pờ rô pờ lem</a></li>
                ...
                <div id="produc-item-right-iphone">
                    ...
                    <table>
                        <thead>
                            <tr class="title_sp">
                                <th colspan="4" style="text-align:right ;"><a style="padding: 6px; text-decoration: none; background-color: #000; color: rgb(234, 232, 232);" href="./add_brand.php">Thêm loại hàng</a></th>
                            </tr>
                            <tr>
                                <th>Mã loại</th>
                                <th>Tên loại</th>
                        ...
                        <tbody>
                            <?php foreach ($listSP as $row) { ?>
                                <tr>
                                    ...
                                    <td><a href="./delete_brand.php?id=<?= $row['brand_id'] ?>" class="button_delete">Xoá</a></td>
                                    <td><a href="./edit_brand.php?id=<?= $row['brand_id'] ?>" class="button_edit">Sửa</a></td>
                                </tr>
                            <?php }  ?>
                        </tbody>
                    </table>
