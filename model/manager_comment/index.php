...
<body>
    ...
    $listSP = manager_comment();
    $search = isset($_GET['name']) ? $_GET['name'] : "";
    $total_row = tongSoHang_cm();
    $item_per_page = !empty($_GET['per_page']) ? $_GET['per_page'] : 4;
    $current_page = !empty($_GET['page']) ? $_GET['page'] : 1;
    $listSP = phanTrangCM($search, $item_per_page, $current_page);
                    ...
                    <tbody>
                        <?php foreach ($listSP as $row) { ?>
                            <tr>
                                ...
                                <td><?= $row['ngay_bl'] ?></td>
                                <td><?= $row['cm_answer'] ?></td>
                                <td><a href="./delete_cm.php?id=<?= $row['id'] ?>" class="button_delete">Xoá</a></td>
                                <td><a href="./answer_cm.php?id=<?= $row['id'] ?>" class="button_edit">Trả lời</a></td>
                            </tr>
                        <?php }  ?>
                    </tbody>
                </table>
